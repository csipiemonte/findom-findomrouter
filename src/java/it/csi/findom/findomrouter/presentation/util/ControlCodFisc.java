...
public class ControlCodFisc {
	...
	*/
	...
	/**
	   * metodo per ottenere un byte[] da uno stream via http.
	   * Utile per ottenere piccoli oggetti da trattare in memoria come
	   * ad esempio una piccola immagine:
	   * byte[] myImage = getObjectFromAnURL(http://dssun3:6464/fpabil/images/immagine.gif");
	   * @param objectUrl
	   * @return
	   */
	public static byte[] getObjectFromAnURL(String objectUrl) {
		byte[] immagineInByte = null;
		try {
			java.net.URL url = new java.net.URL("http://dssun3:6464/fpabil/images/immagine.gif");
			java.net.URLConnection urlConnection = url.openConnection();

//			System.out.println("Urlconnection::" + urlConnection);

			java.io.BufferedInputStream bufferedinputstream = new java.io.BufferedInputStream(url.openStream());
			...
			immagineInByte = baos.toByteArray();
		}catch (MalformedURLException e){
			log.error("[HttpStreamUtils::getObjectFromAnURL] MalformedURLException:", e);
			immagineInByte = new byte[0];
		}catch (IOException e){
			log.error("[HttpStreamUtils::getObjectFromAnURL] IOException:", e);
			immagineInByte = new byte[0];
		}
