					...
					<div class="boxAlter">
                      ...
                      <table class="formTable" summary="...">
                        ...
                        <tr >
                          ...
                          <td colspan="2">Conclusione Domanda</td>
                          <td colspan="2">Invio Domanda</td>
                          <td colspan="2">Classificazione/Protocollazione</td>
                        </tr>
                        ...
                        <tr >
                          ...
                          <td>Codice fiscale</td>
                          <td>
                          	<s:if test="soggConclusione.codiceFiscale != null">
                         	<s:property value="soggConclusione.codiceFiscale" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>  
                         ...
                         <td>N&#186; protocollo domanda</td>
                         <td>  
                         	<s:if test="domanda.numeroProtocollo != null">
                         	<s:property value="domanda.numeroProtocollo" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
                         ...
                         <tr >
                          ...
                          <td>Nome</td>
                          <td>  
                         	<s:if test="soggConclusione.nome != null">
                         	<s:property value="soggConclusione.nome" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
                         ...
                         <td>Data protocollo</td>
                          <td>  
                         	<s:if test="domanda.dtProtocolloDomanda != null">
                         	<s:property value="domanda.dtProtocolloDomanda" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
                         ...
                         <tr >
                          ...
                          <td>Cognome</td>
                         <td>  
                         	<s:if test="soggConclusione.cognome != null">
                         	<s:property value="soggConclusione.cognome" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
                         ...
                         <td>Data classificazione</td>
                          <td>  
                         	<s:if test="domanda.dtClassificazioneDomanda != null">
                         	<s:property value="domanda.dtClassificazioneDomanda" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
                         ...
                         <tr >
                          ...
                          <td>Data</td>
                           <td>  
                         	<s:if test="domanda.dtConclusioneDomanda != null">
                         	<s:property value="domanda.dtConclusioneDomanda" />
                         	</s:if>
                         	<s:else>
                         		-	
                         	</s:else>
